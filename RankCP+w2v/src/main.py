...
def main(configs, fold_id):
    ...
    for epoch in range(1, configs.epochs+1):
        ...
        with torch.no_grad():
            ...
            print("metric_ec: P = {}, R = {}, F = {}".format(metric_ec[0], metric_ec[1], metric_ec[2]))
            print("metric_e: P = {}, R = {}, F = {}".format(metric_e[0], metric_e[1], metric_e[2]))
            print("metric_c: P = {}, R = {}, F = {}".format(metric_c[0], metric_c[1], metric_c[2]))
